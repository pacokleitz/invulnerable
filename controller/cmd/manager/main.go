...
import (
	...
	"github.com/pacokleitz/invulnerable/controller/internal/controller"
)
...
func init() {
	...
	utilruntime.Must(invulnerablev1alpha1.AddToScheme(scheme))
}
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "invulnerable-controller-leader-election",
	})
	if err != nil {
